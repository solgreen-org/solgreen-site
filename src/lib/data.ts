...
export const pillars = [
  ...
  },
  {
    ...
    description: "Baterias de lítio para backup inteligente e continuidade de operação. Sua empresa nunca para.",
  ...
  },
  {
    ...
    description: "Monitoramento de consumo, gestão de demanda e controle inteligente para operações que precisam de eficiência.",
...
export const sectors = [
  {
    ...
    description: "Automação de galpões, backup instantâneo de energia e monitoramento de temperatura e ventilação. Sua granja produz mais, gasta menos e nunca para.",
  ...
  },
  {
    ...
    pain: "Demanda por capacidade instalada sem depender de terceiros.",
    description: "EPC completo de usinas fotovoltaicas para cooperativas de geração, permissionárias e comercializadoras. Da simulação ao comissionamento.",
  ...
  },
  {
    ...
    pain: "Conta de luz alta, equipamentos vulneráveis a apagões.",
    description: "Solar para redução de conta, backup para proteger equipamentos e estoque, monitoramento para identificar desperdício.",
